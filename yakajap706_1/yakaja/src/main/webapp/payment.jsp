		      ...
		      <form action="" method="get">
		        <table class="table table-bordered">
		          <tr>   
		            ...
		            <td><input type="text" id="mem_name" name="mem_name" value="${sessionScope.memberVO.mem_name}" readonly class="form-control"></td>
		          </tr>
		          <tr>
		           	<td>
					  <div class="d-flex align-items-center">
		            ...
		            <td><input type="text" id="mem_email" name="mem_email" value="${sessionScope.memberVO.mem_email}" readonly class="form-control"></td>
		          </tr>
		          <tr>
		           	<td>
					  <div class="d-flex align-items-center">
		          ...
		          <tr>
		            ...
		            <td><input type="text" id="room_price" name="room_price" value="${param.total_price}" readonly class="form-control mb-0"></td>
		          </tr>
		          <tr>
		            <td>
					  <div class="d-flex align-items-center">
		            ...
		            <td><input type="text" id="mem_tel" name="mem_tel" value="${sessionScope.memberVO.mem_tel}" readonly class="form-control"></td>
		          </tr>
		          <tr>
		            <td>
					  <div class="d-flex align-items-center">
		          ...
		          <tr>
		            <td colspan="2" align="center">
		            	...
		            	<input type="hidden" id="mem_id" name="mem_id" value="${sessionScope.memberVO.mem_id}">
		            </td>
		          </tr>
		        </table>
		      </form>
