...
<% stateCheck=String.valueOf(request.getAttribute("name")); 
	hotelName=stateCheck;%> <!-- 여기서 널			지역이름 -->
...
<table border=0 align="center">
	<tr>
		<td colspan=8>
		<form action="searchHotelWhere_Sort.do" method="post">	<!-- .do -->
			<div align="center">
					...
					<input type="hidden" name="where2" value="<%=stateCheck%>">
			</div>
		</form>
		</td>
	</tr>
